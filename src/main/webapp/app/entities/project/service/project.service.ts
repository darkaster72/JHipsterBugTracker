...
export class ProjectService {
  ...
  update(project: IProject): Observable<EntityResponseType> {
    return this.http.put<IProject>(`${this.resourceUrl}/${getProjectIdentifier(project) as string}`, project, { observe: 'response' });
  }

  partialUpdate(project: IProject): Observable<EntityResponseType> {
    return this.http.patch<IProject>(`${this.resourceUrl}/${getProjectIdentifier(project) as string}`, project, { observe: 'response' });
  }
